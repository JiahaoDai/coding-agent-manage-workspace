# 07 — Create-time resume of existing native sessions

**What to build:** When creating a session for a directory + agent that already has native sessions, the user is offered "resume existing" vs "new", with the name prefilled from the native summary or first prompt.
